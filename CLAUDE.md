...
페이즈 0~11 완료 상태 — 다음 작업은 ROADMAP의 **Phase 12 (학습 활동 설명 필드, 계획 확정)**, 그 외는 "후순위 후보" 참고. 문서 스키마는 v2 (equipmentLayout) — Phase 12 구현 시 v3(learningActivity)로 올리고 이 줄도 갱신할 것.
