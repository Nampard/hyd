...
const ko = {
  ...
  wireSelected: "배선이 선택되었습니다. Delete 키나 🗑 부품 삭제 버튼으로 삭제할 수 있습니다.",
  noProperties: "설정할 속성이 없습니다.",
  editHint: "R 키: 회전 · Delete 키(또는 🗑 버튼): 삭제",
  simEditLock: "시뮬레이션 중에는 속성을 변경할 수 없습니다.",
  statusDefault: "포트(○)를 클릭하면 배선을 시작합니다. 빈 곳 드래그: 화면 이동 · 휠·두 손가락·＋－: 확대/축소",
...
const en: Record<keyof typeof ko, string> = {
  ...
  wireSelected: "Wire selected. Press Delete or the 🗑 button to remove it.",
  noProperties: "No properties to configure.",
  editHint: "R: rotate · Delete (or 🗑): remove",
  simEditLock: "Properties are locked while the simulation runs.",
  statusDefault: "Click a port (○) to start wiring. Drag empty space: pan · Wheel / pinch / ＋－: zoom",
